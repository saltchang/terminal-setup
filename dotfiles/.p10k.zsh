# Generated by Powerlevel10k configuration wizard on 2024-06-24 at 11:47 CST.
...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      (( $#branch > 60 )) && branch[20,-20]="…"  # <-- this line
  ...
  #   emulate -L zsh -o extended_glob
  #   if [[ -n ./(../)#(.git)(#qN/) ]]; then
  #     p10k display '1'=show '2'=show '3/left/prompt_char'=show '3/right'=show '4'=hide
  #   else
  #     p10k display '1'=show '2'=hide '3'=hide '4'=show
  #   fi
  # }
